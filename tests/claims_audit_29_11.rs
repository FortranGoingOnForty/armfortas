...
fn o3_vectorizes_realworld_explicit_do_stage() {
    ...
    // Since x10 both arches vectorize this loop (NeonVectorize on
    // arm64, SseVectorize on x86); the vector IR claims are
    // target-neutral, only the mnemonic claims branch per arch.
