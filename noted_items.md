...
- Broaden formatted `integer(16)` input coverage. Top-level scalar formatted internal
  `READ` now has a real parser-backed path, but external formatted input and richer
  formatted descriptor coverage still need honest wide support.
