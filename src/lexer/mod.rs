...
pub fn is_keyword(name: &str) -> Option<Keyword> {
    match name.to_lowercase().as_str() {
        ...
        "endprogram" => Some(Keyword::EndProgram),
        "module" => Some(Keyword::Module),
        "endmodule" => Some(Keyword::EndModule),
        "submodule" => Some(Keyword::Submodule),
        "endsubmodule" => Some(Keyword::EndSubmodule),
        ...
        "doubleprecision" => Some(Keyword::DoublePrecision),
        "doublecomplex" => Some(Keyword::DoubleComplex),
        ...
        "endinterface" => Some(Keyword::EndInterface),
